...
CREATE TABLE IF NOT EXISTS `sent_activity` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='活动管理' AUTO_INCREMENT=3 ;
...
(1, '报名减免', 200, '', 2018, 2018, 0, 0, '直接报名可以享受200元学费减免'),
(2, '报名减免', 300, '', 2018, 2018, 0, 0, '直接报名可以享受300元学费减免');
...
(1, 'admin', '9d98696a650b7bd9c90f057023951aa3', 'admin', 'admin@admin.com', NULL, 0, '0000-00-00', '', 0, NULL, 0, 0, 0, 0, 'nPdbMU', 54, 0, 1489650033, 2130706433, 1541657443, 1),
...
INSERT INTO `sent_student` (`id`, `name`, `phone`, `card`, `grade_id`, `area_id`, `activity_id`, `coupon`, `inviter`, `sign_date`, `pay_date`, `status`, `tuition_state`, `payable`, `payment`, `unpaid`, `openId`, `sn`) VALUES
(1, '张三', '13594855879', '500236199101226203', 4, 1, '1,2', 1, 1, 1234567890, 1234567890, 1, 1, '111.00', '111.00', '0.00', 'o2l0cwgiEglPnZKRmOc8b9SWOBC4', 'dj_15368421461PCtrZCq'),
(2, '李四', '13594855878', '500236199101226204', 7, 1, '1', 1, 2, 1234567890, 1234567890, 1, 1, '111.00', '111.00', '0.00', 'o2l0cwgiEglPnZKRmOc8b9SWOBC4', 'dj_15368421461PCtrZCw');
