...
(1, 'admin', '9d98696a650b7bd9c90f057023951aa3', 'admin', 'admin@admin.com', NULL, 0, '0000-00-00', '', 0, NULL, 0, 0, 0, 0, 'nPdbMU', 43, 0, 1489650033, 2130706433, 1541052697, 1),
...
(3, '运营管理', 'admin', 'list', 0, 2, 'admin/category/index', 0, '', '', 0, 0),
...
(37, '运营管理', 'admin', '', 0, 0, 'admin/operate/index', 1, '', '运营管理', 0, 0),
(38, '运营管理', 'admin', '', 37, 0, 'admin/operate/index', 0, '', '运营管理', 0, 0);
...
CREATE TABLE IF NOT EXISTS `sent_page` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='单页' AUTO_INCREMENT=11 ;
...
(1, 0, '走进鼎吉', 4, 0, '<p>走进鼎吉111</p>', 1540951806, 1540977224),
...
(10, 0, '测试', 4, 0, '<p>测试</p>', 1540978129, 1540978129),
