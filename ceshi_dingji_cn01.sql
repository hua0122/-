...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='文档模型基础表' AUTO_INCREMENT=41 ;
...
(13, 1, '', '首页banner图2', 1, '', 3, 1, 0, 16, 0, 1541052794, 0, 0, 0, 0, 0, 0, 1541052794, 1541052851, 1),
...
(20, 1, '', '发现最美鼎吉3', 9, '', 3, 1, 0, 23, 0, 1541055193, 0, 0, 0, 0, 0, 0, 1541055193, 1541055219, 1),
(21, 1, '', '走进鼎吉1', 3, '', 3, 1, 0, 24, 0, 1541056368, 0, 0, 0, 0, 0, 0, 1541056368, 1541056789, 1),
(22, 1, '', '走进鼎吉2', 3, '', 3, 1, 0, 25, 0, 1541056794, 0, 0, 0, 0, 0, 0, 1541056794, 1541056814, 1),
(23, 1, '', '走进鼎吉3', 3, '', 3, 1, 0, 26, 0, 1541056819, 0, 0, 0, 0, 0, 0, 1541056819, 1541056834, 1),
(24, 1, '', '走进鼎吉4', 3, '', 3, 1, 0, 27, 0, 1541056839, 0, 0, 0, 0, 0, 0, 1541056839, 1541056862, 1),
(25, 1, '', '走进鼎吉5', 3, '', 3, 1, 0, 28, 0, 1541056867, 0, 0, 0, 0, 0, 0, 1541056867, 1541056888, 1),
...
(31, 1, '', '团队风采1', 11, '', 3, 1, 0, 34, 0, 1541058400, 0, 0, 0, 0, 0, 0, 1541058400, 1541058422, 1),
(32, 1, '', '团队风采2', 11, '', 3, 1, 0, 35, 0, 1541058426, 0, 0, 0, 0, 0, 0, 1541058426, 1541058442, 1),
(33, 1, '', '团队风采3', 11, '', 3, 1, 0, 36, 0, 1541058446, 0, 0, 0, 0, 0, 0, 1541058446, 1541058464, 1),
(34, 1, '', '团队风采4', 11, '', 3, 1, 0, 37, 0, 1541058469, 0, 0, 0, 0, 0, 0, 1541058469, 1541058491, 1),
(35, 1, '', '团队风采5', 11, '', 3, 1, 0, 38, 0, 1541058495, 0, 0, 0, 0, 0, 0, 1541058495, 1541058508, 1),
...
(1, 'admin', '9d98696a650b7bd9c90f057023951aa3', 'admin', 'admin@admin.com', NULL, 0, '0000-00-00', '', 0, NULL, 0, 0, 0, 0, 'nPdbMU', 52, 0, 1489650033, 2130706433, 1541466455, 1),
...
CREATE TABLE IF NOT EXISTS `sent_page` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='单页' AUTO_INCREMENT=13 ;
...
(1, 0, '约考缴费流程', 4, 53, '<p>测试</p>', 1541497568, 1541497568),
(2, 0, '发现最美鼎吉', 4, 0, '<p>发现最美鼎吉1</p>', 1540951806, 1540977206),
(3, 0, '教练风采', 4, 0, '<p>教练风采</p>', 1540951830, 1540971862),
(4, 0, '团队风采', 4, 0, '<p>团队风采</p>', 1540951849, 1540971900),
(10, 0, '科目一学习预约流程', 4, 0, '<p>测试</p>', 1540978129, 1540978129),
(11, 0, '学车协议', 4, 0, '<p>学车协议</p>', 1540972058, 1540972069),
(12, 0, '约考缴费流程', 4, 0, '<p>测试456</p>', 1541497659, 1541497659),
(5, 0, '学员风采', 4, 0, '<p>学员风采</p>', 1540971904, 1540971917),
(6, 0, '学车流程', 4, 0, '<p>学车流程</p>', 1540971942, 1540971957),
(7, 0, '优势服务', 4, 0, '<p>优势服务</p>', 1540971963, 1540971976),
(8, 0, '学车保障', 4, 0, '<p>学车保障</p>', 1540972041, 1540972054),
(9, 0, '常见问题', 4, 0, '<p>常见问题</p>', 1540972058, 1540972069);
...
CREATE TABLE IF NOT EXISTS `sent_student` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='学员管理表' AUTO_INCREMENT=1 ;
